...
class PracZespEtatContentProvider : ContentProvider() {
    ...
    override fun delete(uri: Uri, selection: String?, selectionArgs: Array<String>?): Int {
        ...
        when (sUriMatcher.match(uri)) {
            ...
            /*DONE: dodaj obsługę tabeli PRACOWNICY dla metody delete */
            PRACOWNICY -> return db.delete(PracZespEtatContract.Pracownicy.TABLE_NAME, selection, selectionArgs)
    ...
    override fun getType(uri: Uri): String? {
        ...
        when (sUriMatcher.match(uri)) {
            ...
            /*DONE: dodaj obsługę tabeli PRACOWNICY dla metody getType */
            PRACOWNICY -> return "vnd.android.cursor.dir/vnd.com.example.kjankiewicz.android_07c01.praczespetat." + PracZespEtatContract.Pracownicy.TABLE_NAME
            else -> throw IllegalArgumentException("Not yet implemented")
        }
    }
    ...
    override fun insert(uri: Uri, values: ContentValues?): Uri? {
        ...
        return when (sUriMatcher.match(uri)) {
            ...
            /*DONE: dodaj obsługę tabeli PRACOWNICY dla metody insert */
            PRACOWNICY -> {
                newRowId = db.insert(PracZespEtatContract.Pracownicy.TABLE_NAME, null, values)
                ContentUris.withAppendedId(uri, newRowId)
            }
            else -> throw IllegalArgumentException("Not yet implemented")
        }
    ...
    override fun query(uri: Uri, projection: Array<String>?, selection: String?,
        ...
        return when (sUriMatcher.match(uri)) {
            ...
            ETATY -> db.query(PracZespEtatContract.Etaty.TABLE_NAME,
                    projection, selection, selectionArgs, null, null, sortOrder)
            /*DONE: dodaj obsługę tabeli PRACOWNICY dla metody query */
            PRACOWNICY -> db.query(PracZespEtatContract.Pracownicy.TABLE_NAME,
                    projection, selection, selectionArgs, null, null, sortOrder)
            else -> throw IllegalArgumentException("Not yet implemented")
        }
    }
    ...
    override fun update(uri: Uri, values: ContentValues?, selection: String?,
        ...
        return when (sUriMatcher.match(uri)) {
            ...
            /*DONE: dodaj obsługę tabeli PRACOWNICY dla metody update */
            PRACOWNICY -> db.update(PracZespEtatContract.Pracownicy.TABLE_NAME, values, selection, selectionArgs)
            else -> throw IllegalArgumentException("Not yet implemented")
        }
    }
