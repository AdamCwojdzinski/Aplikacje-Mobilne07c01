...
class MyPracownicyActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*DONE: Utwórz instancję klasy SQLiteOpenHelper korzystając z konstruktora właściwej klasy
        * Za jej pomocą będzie możliwe operowanie na zawartości bazy danych */
        ...
        findViewById<Button>(R.id.createNewDatasetButton).setOnClickListener {
            ...
            /*DONE: Otwórz bazę danych w trybie do zapisu i pobierz do niej referencję
             * Skorzystaj z metody getWritableDatabase klasy SQLiteOpenHelper */
            db = mDbHelper!!.writableDatabase

            /*DONE: Usuń zawartość tabeli PRACOWNICY z bazy danych SQLite */
            deleteResult = db!!.delete(PracZespEtatContract.Pracownicy.TABLE_NAME, null, null)
            ...
            for (i in 0..13) {
                ...
                /*DONE: Umieść instrukcję wstawiającą do tabeli PRACOWNICY kolejne wiersze na podstawie zmiennej values
                * mapującej określone wartości do określonych kolumn */
                val recId = db?.insert(PracZespEtatContract.Pracownicy.TABLE_NAME, null, values)

            }
            /*DONE: Umieść instrukcję zamykającą bazę danych SQLite dostępną za pomocą zmiennej db */
            db!!.close()
        }
        ...
        findViewById<Button>(R.id.refreshButton).setOnClickListener { v ->
            ...
            val pracownicyListItems = intArrayOf(
                    R.id.nazwiskoTextView,
                    R.id.etatTextView)
        ...
        findViewById<Button>(R.id.getCountButton).setOnClickListener { view ->
            /*DONE: Popraw poniższe dwie instrukcje tak, aby poznać liczbę rekordów w tabeli PRACOWNICY
            * Uzyskaj te informacje za pomocą uzupełnionego dostawcy usług PracZespEtatContentProvider */
            ...
            countCursor = contentResolver.query(
                    PracZespEtatContract.Pracownicy.CONTENT_URI,
